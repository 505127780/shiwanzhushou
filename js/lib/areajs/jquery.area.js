...
function intProvince(flag) {
	...
	if(flag){
		$('.selet-area-wrap .one').html(" ").parent('p').removeClass("current");
	}else{
		if($('.selet-area-wrap .one').html()!='')
		$('.selet-area-wrap .one').parent('p').addClass("current");
		
	}
	$('.selet-area-wrap .two').html("").parent('p').removeClass("current").attr("onClick", ";");
}
intProvince(1);
...
//	alert(expressArea)
	if(flag==0){
		$('.selet-area-wrap .one').html(expressArea).parent('p').removeClass("current");
	}
	else{
		
		$('.selet-area-wrap .one').html(expressArea).parent('p').addClass("current");
	}
...
function selectC(p,c) {
	...
	if(sCity==""){
		$('.selet-area-wrap .two').html("直辖市").parent('p').addClass("current");
	}
	else{
		$('.selet-area-wrap .two').html(sCity).parent('p').addClass("current");
		
	}
	$('.selet-area-wrap .one').parent('p').removeClass("current");
...
function clockArea() {
	...
	$("#areaMask, #closeArea").click(function() {
		clockArea();
		$('.selet-area-wrap .one,.selet-area-wrap .two').html("").parent('p').removeClass("current");
...
function selectPP(p,c){
	$('.selet-area-wrap .two').html("").parent('p').removeClass("current");
	selectP(p,c);
